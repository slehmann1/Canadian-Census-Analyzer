...
class Census:
    def __init__(self, year, url, filename_keep, filename_csv, filename_par, leading_spaces, characteristic_col, geo_col, total_col,
...
# TODO: Add censuses from earlier years

censuses = [Census(2011, "https://www12.statcan.gc.ca/census-recensement/2011/dp-pd/prof/details/download-telecharger/comprehensive/comp_download.cfm?CTLG=98-316-XWE2011001&FMT=CSV301&Lang=E&Tab=1&Geo1=PR&Code1=01&Geo2=PR&Code2=01&Data=Count&SearchText=&SearchType=Begins&SearchPR=01&B1=All&Custom=&TABID=1","98-316-XWE2011001-301.CSV", "2011CensusData.CSV", "2011CensusData.parquet", 3, "Characteristics", "Prov_Name", "Total",
